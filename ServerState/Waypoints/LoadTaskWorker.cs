...
namespace Nova.Server.Waypoints
{
    ...
    /// </summary>
    public class LoadTaskWorker : LoadTask, IWaypointTaskWorker
    {
        public LoadTaskWorker(IWaypointTask task)
        {
            Amount = ((LoadTask)task).Amount;
        }
        ...
        public LoadTaskWorker(XmlNode node) : base(node)
        {
