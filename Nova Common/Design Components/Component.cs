      ...
      public Component(XmlNode node)
      {
          ...
          while (subnode != null)
          {
              try
              {
                  ...
                  else if (subnode.Name.ToLower() == "type")
                  {
                      this.Type = ((XmlText)subnode.FirstChild).Value;
                  }
                  else if (subnode.Name.ToLower() == "mass")
                  {
                      this.Mass = int.Parse(((XmlText)subnode.FirstChild).Value);
                  }
                  else if (subnode.Name.ToLower() == "resource")
                  {
                      this.Cost = new Resources(subnode); 
                  }
                  else if (subnode.Name.ToLower() == "tech")
                  {
                      this.RequiredTech = new TechLevel(subnode);
                  }
                  else if (subnode.Name.ToLower() == "description")
                  {
                      this.Description = (String)((XmlText)subnode.FirstChild).Value;
                  }
                  else if (subnode.Name.ToLower() == "race_restrictions")
                  {
                  ...
                  else if (subnode.Name.ToLower() == "property")
                  {
