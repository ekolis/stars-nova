...
namespace Nova.Common
{
	...
	/// <summary>
	/// Class defining the set of technology levels required to gain access to a component.
	/// </summary>
	[Serializable]
	...
	public class TechLevel
	{
		...
		/// <summary>
		/// Does this set of tech levels meet a required set of tech levels?
		/// </summary>
		/// <remarks>This is functinonally identical to the >= operator, but it's easier to comprehend.</remarks>
		/// <param name="req">The required tech levels.</param>
		/// <returns>true if the requirement is met, otherwise false</returns>
		public bool Meets(TechLevel req)
		{
			foreach (var tech in ResearchKeys)
			{
				if (techValues[tech] < req.techValues[tech])
