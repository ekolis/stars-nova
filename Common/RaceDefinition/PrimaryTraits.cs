...
namespace Nova.Common
{
    ...
    public static class PrimaryTraits
    {
        ...
        private const string WarMongerDescription = "You rule the batle field. Your colonists attack better, your ships are faster in battle and you build weapons 25% cheaper than other races You start the game with a knowledge of Tech 6 weapons and Tech 1 in Energy and propulsion. Unfortunately, your race doesn\'t understand the necessity of building any but the most basic planetary Defenses and cannot lay mine fields.";
