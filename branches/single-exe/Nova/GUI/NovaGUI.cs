...
using System;
using Nova.Gui.Controls;
using Nova.Gui.Dialogs;
using Nova.Gui.Reports;
using NovaCommon;
using NovaClient;
...
namespace Nova.Gui
{
    ...
    public class NovaGUI : System.Windows.Forms.Form
    {
        ...
        public Nova.Gui.Controls.SelectionDetail SelectionDetail;
        ...
        private void InitializeComponent()
        {
            ...
            this.MapControl = new Nova.Gui.Controls.StarMap();
            ...
            this.SelectionDetail = new Nova.Gui.Controls.SelectionDetail();
            this.SelectionSummary = new Nova.Gui.Controls.SelectionSummary();
            this.messages = new Nova.Gui.Controls.Messages();
