...
using Nova.ComponentEditor.Dialogs;
namespace Nova.ComponentEditor
{
   partial class ComponentEditorWindow
   {
      ...
      private void InitializeComponent()
      {
          ...
          this.ComponentImage = new ComponentEditor.Dialogs.ImageDisplay();
          this.TechRequirements = new ComponentEditor.Dialogs.TechRequirements();
          this.BasicProperties = new ComponentEditor.Dialogs.BasicProperties();
