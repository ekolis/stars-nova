...
namespace Nova.Server.Waypoints
{
    ...
    /// </summary>
    public class ColoniseTaskWorker : ColoniseTask, IWaypointTaskWorker
    {
        public ColoniseTaskWorker(IWaypointTask task)
        {

        }
        
        /// <summary>
        /// Load: Read in a ColoniseTaskWorker from and XmlNode representation.
        /// </summary>
        /// <param name="node">An XmlNode containing a representation of a ColoniseTaskWorker</param>
        public ColoniseTaskWorker(XmlNode node) : base(node)
        {
        ...
        public bool Perform(Fleet fleet, Mappable target, ServerData serverState)
        {
            ...
            serverState.AllEmpires[fleet.Owner].StarReports[star.Name].Update(star, ScanLevel.Owned, serverState.TurnYear);
