...
// generate a turn (including the very first one).
//
...
{
   [Serializable]
   public sealed class GlobalTurn
   {
...
// ============================================================================
      ...
      private static GlobalTurn      instance  = null;
...
// ============================================================================
      ...
      public static GlobalTurn Data
      {
         get {
            lock(padlock) {
               if (instance == null) {
                  instance = new GlobalTurn();
               }
               return instance;
            }
         }
